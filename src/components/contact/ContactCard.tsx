...
export function ContactCard({ onClose }: ContactCardProps) {
  ...
  return (
    <div
      className="relative flex w-[min(92vw,500px)] flex-col items-center gap-6 overflow-hidden rounded-[24px] border border-white/10 p-8 shadow-2xl"
      style={{
    ...
    >
      ...
      >
        <img src={withBase('/assets/icons/close_btn.svg')} alt={uiCopy.contact.closeIconAlt} className="h-[32px] w-[32px]" />
      </button>

      <p className="mt-2 w-full text-center text-[24px] [font-family:var(--font-sans-en)] leading-[24px] text-white">
      ...
      <div className="flex w-full items-center justify-center gap-6">
        <a href={contact.linkedinUrl} target="_blank" rel="noreferrer" className="flex flex-shrink-0 items-center justify-center transition-opacity hover:opacity-80">
          <img src={withBase('/assets/icons/linkedin.svg')} alt="LinkedIn" className="h-[36px] w-[36px] object-contain" />
        </a>
        ...
        <a href={contact.instagramUrl} target="_blank" rel="noreferrer" className="flex flex-shrink-0 items-center justify-center transition-opacity hover:opacity-80">
          <img src={withBase('/assets/icons/instagram.svg')} alt="Instagram" className="h-[36px] w-[36px] object-contain" />
        </a>
        ...
        <div className="flex items-center gap-3">
          <img src={withBase('/assets/icons/wechat.svg')} alt={uiCopy.contact.wechatIconAlt} className="h-[36px] w-[36px] flex-shrink-0 object-contain" />
          <CopyableText
